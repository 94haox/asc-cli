...
| Architecture / API change | `AGENTS.md` (update architecture / patterns sections), `docs/features/<feature>.md` |
| Auth / config change | `AGENTS.md` (Authentication section), `README.md` |
...
**`AGENTS.md`** — update when architecture patterns, file locations, or design rules change.
